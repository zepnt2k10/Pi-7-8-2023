...
\begin{multicols}{2}
	...
	\PIbox{
		...
		An example of how a column is changed shown as below in the board on the right. It is possible to change all the signs of the board to + after finitely many steps?}
	\begin{center}
		\begin{tikzpicture}[scale=0.78]
	...
	\PIbox{
		...
		\vskip 0.1cm
		Is it possible that when he leaves the room, the numbers of tails--up nickles are the same on both tables?}
	\vskip 0.2cm
	\textit{Solution.}
